...
class Timeline4Page extends StatefulWidget {
  @override
  _Timeline4PageState createState() => _Timeline4PageState();
}
  ...
  Widget _timeline({required int step, required String title, required String desc, String position='mid'}){
    return TimelineTile(
      ...
      indicatorStyle: IndicatorStyle(
          indicatorXY: position=='first'?0:position=='last'?1:0.5,
          width: 40,
          height: 40,
          indicator: Container(
      ...
      startChild: step.isEven?Container(
